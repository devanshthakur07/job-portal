...
import com.dec24.jobportal.entity.*;
import com.dec24.jobportal.services.JobPostActivityService;
import com.dec24.jobportal.services.JobSeekerApplyService;
import com.dec24.jobportal.services.JobSeekerSaveService;
    ...
    public String searchJobs(Model model,
        ...
        if(!(authentication instanceof AnonymousAuthenticationToken)) {
            ...
            if(authentication.getAuthorities().contains(new SimpleGrantedAuthority("Recruiter"))){
                ...
                List<JobSeekerSave> jobSeekerSavesList = jobSeekerSaveService.getCandidatesJob((JobSeekerProfile) currentUserProfile);
                ...
                for(JobPostActivity jobActivity : jobPost) {
                    ...
                    for(JobSeekerSave jobSeekerSave: jobSeekerSavesList) {
